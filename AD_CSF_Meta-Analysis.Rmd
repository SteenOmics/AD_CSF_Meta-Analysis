...
### Evaluation of the 21 Biomarker Candidates

Indepedent from our down-selection dataset, we were also interested to assess the AUROC's of the discovery's 21 biomarker candidates in the two validation cohorts. That data is produced here as 21 Visualizations. 
...
### Create every 3-protein Combination

Last, we were interested how our down-selection three protein panel compared to ANY other panel. The code here is by no means the most effective, its pretty 'brute-force' but gets the jobs done as there is <500 combinations. The resulting CSV file informed us about our panel combared to (any) other panel.
